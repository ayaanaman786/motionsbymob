      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-b border-white/10 pb-8 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            >
              Film Archive<span className="text-[#a50000]">.</span>
            </h2>
          </div>
          ...
          <div className="flex flex-wrap gap-2 md:gap-4">
            {(['all', 'feature', 'oem', 'cinematic', 'detail'] as const).map((filter) => (
              <button
                ...
                className={`py-2 px-4 border text-[9px] tracking-widest transition-all duration-300 cursor-pointer uppercase outfit-editorial ${
                  activeFilter === filter
                    ? 'bg-[#a50000] border-[#a50000] text-white shadow-[0_0_10px_rgba(165,0,0,0.4)]'
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-20 border border-white/10 bg-zinc-950/20">
            <Film className="w-10 h-10 text-gray-600 mx-auto mb-4" />
            <p className="outfit-editorial text-[10px] text-gray-400 uppercase">No files logged under this classification.</p>
          </div>
        )}
          ...
          <div className="relative w-full max-w-5xl bg-[#090909] border border-white/10 z-10 flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.9)] overflow-hidden">
            ...
            <div className="bg-black p-4 md:px-6 border-b border-white/10 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <span className="outfit-editorial text-[8px] text-[#a50000] font-semibold uppercase bg-[#a50000]/10 px-2 py-0.5 border border-[#a50000]/30">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              ...
              <div className="lg:col-span-8 bg-black aspect-video relative flex items-center justify-center">
                {selectedItem.videoUrl ? (
                  ...
                  <div className="absolute inset-0">
                    ...
                    <div className="absolute bottom-4 left-4 bg-black/80 px-3 py-1 border border-white/10 outfit-editorial text-[9px] text-gray-300">
              ...
              <div className="lg:col-span-4 p-6 md:p-8 flex flex-col justify-between bg-black border-t lg:border-t-0 lg:border-l border-white/10">
                <div>
                  <div className="mb-6">
                    <div className="outfit-editorial text-[10px] text-[#a50000] uppercase mb-1">
                  ...
                  <div className="space-y-4 border-t border-white/10 pt-6">
                    <div className="flex justify-between items-center text-xs">
                      <span className="outfit-editorial text-[9px] text-zinc-500">CLASSIFICATION:</span>
                      <span className="outfit-editorial text-[9px] text-white font-semibold uppercase">{selectedItem.category}</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="outfit-editorial text-[9px] text-zinc-500">CHASSIS / ENGINE:</span>
                      <span className="outfit-editorial text-[9px] text-white font-semibold uppercase">{selectedItem.carModel}</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="outfit-editorial text-[9px] text-zinc-500">RELEASE CYCLE:</span>
                      <span className="outfit-editorial text-[9px] text-white font-semibold uppercase">{selectedItem.year}</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="outfit-editorial text-[9px] text-zinc-500">SOURCE ACQUISITION:</span>
                      <span className="outfit-editorial text-[9px] text-[#a50000] font-bold">8K COMPRESSED LOG</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-12 pt-6 border-t border-white/10 flex gap-4">
                  <button 
                    ...
                    className="flex-1 py-3 bg-[#a50000] hover:bg-[#c60000] text-white outfit-editorial text-[10px] uppercase transition-all duration-300 text-center cursor-pointer"
                  >
                    ACQUIRE FOR PROJECT
                  </button>
                </div>
