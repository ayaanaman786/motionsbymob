...
export default function Contact() {
  ...
  const socialChannels = [
    {
      ...
      icon: <Instagram className="w-4 h-4 text-[#ff2a2a]" />,
    ...
    },
    {
      ...
      icon: <Phone className="w-4 h-4 text-[#ff2a2a]" />,
  ...
  return (
    <section id="contact" className="bg-black py-24 md:py-32 px-4 md:px-8 relative border-t border-white/10 overflow-hidden">
      ...
      <div className="absolute bottom-0 inset-x-0 h-[400px] bg-gradient-to-t from-[#ff2a2a]/3 to-transparent pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div>
              ...
              >
                Channels<span className="text-[#ff2a2a]">.</span>
              </h2>
            </div>
            ...
            <div className="pt-6 border-t border-white/10 space-y-6">
              <div className="space-y-2">
                <span className="outfit-editorial text-[11px] text-zinc-400 uppercase block">
                  COORDINATION ACCESS
                </span>
              ...
              <div className="flex items-center gap-3 py-2 px-3 bg-[#141414]/40 border border-white/5 rounded-sm inline-flex">
                <span className="w-1.5 h-1.5 bg-[#ff2a2a] rounded-full animate-ping" />
          ...
          <div className="lg:col-span-7 bg-zinc-900/60 border border-white/10 p-8 md:p-10 relative">
            
            {/* Outline accent representing precision camera lines */}
            <div className="absolute top-0 right-10 w-24 h-[1px] bg-[#ff2a2a] shadow-[0_0_8px_#ff2a2a]" />
            
            <div className="mb-8">
              <div className="outfit-editorial text-[11px] text-[#ff2a2a] mb-1">
                [ DIRECT DISPATCH CHANNELS ]
              </div>
              <h3 className="brutal text-2xl tracking-tight text-white mb-4">
                Secure Connection<span className="text-[#ff2a2a]">_</span>
              </h3>
            </div>
            ...
            <div className="space-y-4 mb-8">
              {socialChannels.map((chan, idx) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group block p-5 bg-black/60 border border-white/10 hover:border-[#ff2a2a]/40 hover:bg-[#ff2a2a]/3 transition-all duration-300 relative overflow-hidden cursor-pointer"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-sm bg-zinc-900 border border-white/10 flex items-center justify-center transition-colors group-hover:border-[#ff2a2a]/30">
                        {chan.icon}
                      </div>
                      <div>
                        ...
                        <h4 className="outfit-editorial text-[11px] font-bold text-white uppercase tracking-wider group-hover:text-[#ff2a2a] transition-colors duration-200">
                          {chan.handle}
                        </h4>
                      </div>
                    </div>
                    <ArrowUpRight className="w-4 h-4 text-zinc-600 group-hover:text-[#ff2a2a] transition-all duration-300 transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                  </div>
                  <p className="outfit-editorial text-[11px] text-zinc-400 uppercase mt-3 leading-relaxed max-w-md opacity-80">
                    {chan.desc}
                  </p>
                </a>
              ))}
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="outfit-editorial text-[12px] text-white font-bold tracking-widest selection:bg-[#ff2a2a]">
                      {contactEmail}
                    </span>
                  </div>
                </div>
                ...
                <button
                  onClick={handleCopy}
                  className={`w-full sm:w-auto py-2.5 px-5 rounded-sm outfit-editorial text-[11px] font-bold uppercase transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer border ${
                    copied
                      ? 'bg-[#ff2a2a]/15 border-[#ff2a2a] text-white'
                      : 'bg-white hover:bg-[#ff2a2a] text-black hover:text-white border-white'
                  }`}
                >
                  {copied ? (
                    <>
        ...
        {/* Minimal Footer */}
        <div className="mt-24 pt-12 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-6 outfit-editorial text-[11px] text-zinc-400 uppercase">
          <div>
          ...
          <div className="flex gap-6 text-zinc-400">
            <a href="https://instagram.com/motionsbymob" target="_blank" rel="noreferrer" className="hover:text-white transition-colors duration-200 cursor-pointer flex items-center gap-1">
              [ INSTAGRAM <ArrowUpRight className="w-2.5 h-2.5 text-[#ff2a2a]" /> ]
            </a>
            <a href="https://wa.me/923106552666" target="_blank" rel="noreferrer" className="hover:text-white transition-colors duration-200 cursor-pointer flex items-center gap-1">
              [ WHATSAPP <ArrowUpRight className="w-2.5 h-2.5 text-[#ff2a2a]" /> ]
            </a>
          </div>
        </div>
